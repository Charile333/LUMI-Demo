...
const EntertainmentPage = () => {
  ...
  const { markets: entertainmentMarkets, loading, error } = useMarketsByCategory('entertainment');
  ...
  let filteredMarkets = selectedCategory === 'all' 
    ...
    : entertainmentMarkets.filter(market => 
        (selectedCategory === 'movie-box-office' && market.category === '电影票房') ||
        (selectedCategory === 'music-chart' && market.category === '音乐榜单') ||
        (selectedCategory === 'variety-show' && market.category === '综艺节目') ||
        (selectedCategory === 'pop-culture' && market.category === '流行文化') ||
        (selectedCategory === 'influencer-trend' && market.category === '网红趋势') ||
        (selectedCategory === 'social-heat' && market.category === '社交热度')
      );
